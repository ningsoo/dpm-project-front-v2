...
export const mypageApi = {
  ...
  /** POP 사용취소 - POST /mypage/pop-usage/cancel. popHistoryId 필수, boardId 선택 */
  cancelPopUsage: (body: { userId: number; boardId?: number | null; popHistoryId: number; cancelReason: string }) =>
